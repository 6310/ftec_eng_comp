...
void media (int a[maximo][maximo])
{int som=0;
	for (int i=0;i<maximo;i++)
	{
		for (int j=0;j<maximo;j++)
...
void maior (int a[maximo][maximo])
{int m,posi,posj;
	m=a[0][0];
	for (int i=0;i<maximo;i++)
	{
...
void menor (int a[maximo][maximo])
{int m,posi,posj;
	m=a[0][0];
	for (int i=0;i<maximo;i++)
	{
...
void minimax (int a[maximo][maximo])
...
void totalplinha (int a[maximo][maximo])
{int total[3];
 	for (int i=0;i<maximo;i++)
	{
		total[i]=0;
...
void totalpcoluna (int a[maximo][maximo])
{int total[3];
...
void diagp (int a[maximo][maximo])
{int som=0;
	for (int i=0;i<maximo;i++)
	{
		som+=a[i][i];
...
void diags (int a[maximo][maximo])
{int som=0,j=2;
	for (int i=0;i<maximo;i++)
	{
		som+=a[i][j];
...
void invert (int a[maximo][maximo])
{
	for (int i=2;i>=0;i--)
	{
		for (int j=2;j>=0;j--)
...
void somap (int a[maximo][maximo])
{int som=0;
	for (int i=0;i<maximo;i++)
	{
		for (int j=0;j<maximo;j++)
...
void somai (int a[maximo][maximo])
{int som=0;
	for (int i=0;i<maximo;i++)
	{
		for (int j=0;j<maximo;j++)
...
void ident (int a[maximo][maximo])
{bool id=true;
	for (int i=0;i<maximo;i++)
	{
		for (int j=0;j<maximo;j++)
 ...
 bool leitura=false;
	do
	{
		do
		{
			...
			if (!leitura)
			{
				printf("\n\nA matriz ainda nao foi lida, favor ler a matriz na opcao 1!\n");
				menu=16;
				system("pause");
			}
