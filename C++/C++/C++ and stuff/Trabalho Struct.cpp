...
//====================================================================================================================
void zerar(produtos list[10], int *totalitens, int *totalclientes, float *totalpag, float *media)//OP플O 1
{
	for (int i=0;i<10;i++)
	{
		list[i].cod=0;
...
//====================================================================================================================
void tabela (produtos list[10],int *num)//OP플O 2
{int i=0;
 bool codv=true;
 char cadv;
 	*num=0;
...
//====================================================================================================================
void conta (produtos list[10], int *totalitens, float *totalpag)//OP플O 3
...
//====================================================================================================================
void dia (produtos list[10], int *totalitens, int *totalclientes, float *totalpag, float *media)//OP플O 4
{
